...
function About() {
  return (
    ...
    <h1 className='text-center lg:text-[50px] sm:text-[45px] uppercase leading-[49px] mt-[7%] tracking-[2px] first-letter:text-slate-600 sm:first-letter:text-[69px] first-letter:text-[49px] px-[5vw]'>cognitive intelligence<br/> test 2.0</h1>
    ...
    {/* schedule  */}
    <div>
    <h1 className='text-center xl:text-[50px] lg:text-[50px] md:text-[45px] sm:text-[45px] uppercase leading-[49px] mt-[7%] tracking-[2px] first-letter:text-slate-600 sm:first-letter:text-[69px] first-letter:text-[49px] px-[5vw]'>schedule for cit test 2.0</h1>
    ...
    <div className='flex items-center justify-center mt-[4%] vmd:text-[15px] sm:text-[18px]'>
        ...
        <li className='hover:scale-105 transition-all p-5 bg-slate-300 shadow-2xl shadow-slate-800 rounded-md'><p className=' text-center font-bold text-yellow-500 '>SLOT 1</p><br/>10/09/2024<br/><br/> 9:00 PM - 9:30 PM</li>
        <li className='hover:scale-105 transition-all p-5 bg-slate-300 shadow-2xl shadow-slate-800 rounded-md'><p className='text-yellow-500 font-bold text-center'>SLOT 2</p><br/>10/09/2024<br/><br/>9:00 PM - 9:30 PM</li>
        <li className='hover:scale-105 transition-all p-5 bg-slate-300 shadow-2xl shadow-slate-800 rounded-md'><p className='text-yellow-500 font-bold text-center'>SLOT 3</p><br/>10/09/2024<br/><br/>9:00 PM - 9:30 PM</li>
        </ul>
    </div>
    ...
    <h1 className='uppercase text-center mt-[5%] leading-[30px] vmd:text-[30px] '>cash prizes worth <mark className='p-2 bg-slate-300 shadow-2xl shadow-slate-800 rounded-md'>8k</mark> for cit 2.0</h1>
