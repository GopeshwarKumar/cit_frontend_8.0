...
// 
  return (
    <>
    <div className='bg-[url("/public/assets/citbackground.jpg")]'>
    <Navbar/>
...
{/* Question 1 */}
    ...
    <div className="flex items-center justify-between 2xl:gap-[5vw] xl:gap-[5vw] lg:gap-[5vw] md:gap-[5vw] sm:gap-[5vw] gap-[5vw] 2xl:px-[15] xl:px-[20vw] lg:px-[20vw] md:px-[15vw] sm:px-[15vw] px-[5vw]">
       ...
       <h1 className='text-blue-600 2xl:text-[35px] xl:text-[35px] lg:text-[35px] md:text-[35px] sm:text-[35px] text-[20px] leading-[20px]'>What is CIT 7.0</h1>
        {ansactive && 
    ...
    <div className="flex items-center justify-between 2xl:gap-[5vw] xl:gap-[5vw] lg:gap-[5vw] md:gap-[5vw] sm:gap-[5vw] gap-[5vw] 2xl:px-[15] xl:px-[20vw] lg:px-[20vw] md:px-[15vw] sm:px-[15vw] px-[5vw]">
       <div className='flex flex-col'>
       <h1 className='text-blue-600 2xl:text-[35px] xl:text-[35px] lg:text-[35px] md:text-[35px] sm:text-[35px] text-[20px] leading-[20px] '>When does it happen ?</h1>
        {ansactive2 && 
    ...
    <div className="flex items-center justify-between 2xl:gap-[5vw] xl:gap-[5vw] lg:gap-[5vw] md:gap-[5vw] sm:gap-[5vw] gap-[5vw] 2xl:px-[15] xl:px-[20vw] lg:px-[20vw] md:px-[15vw] sm:px-[15vw] px-[5vw]">
       <div className='flex flex-col'>
       <h1 className='text-blue-600 2xl:text-[35px] xl:text-[35px] lg:text-[35px] md:text-[35px] sm:text-[35px] text-[20px] leading-[20px] '>Who conducts it ?</h1>
        {ansactive3 && 
