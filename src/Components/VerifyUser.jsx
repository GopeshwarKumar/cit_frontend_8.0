...
function VerifyUser() {
  ...
  return (
    ...
    <h1 className='sm:text-[40px] text-nowrap font-bold px-4 text-black p-5'>Verify Email</h1>
    {active=== true ? 
    <form method='post' onSubmit={LoginUser} className='flex flex-col items-center justify-center gap-2'>
