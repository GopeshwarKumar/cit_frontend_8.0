  ...
  return (
    ...
    <table className='tableee w-screen h-[40vh] flex flex-col items-center p-3 gap-[1vh]  overflow-y-scroll'>
     {/* #5F185A  #DBCCC7*/}
      ...
      <th className=' text-cyan-400 w-[50vw] tracking-wider lg:text-[25px] sm:text-[24px] mb:text-[16px] vmd:text-[14px]'>{x.candidatename}</th>
      <th className='text-yellow-400  font-extrabold mb:text-[16px]'>{x.finalScore}</th>
    </tr>
    })}
