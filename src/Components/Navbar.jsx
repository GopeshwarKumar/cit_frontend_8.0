    ...
    <>
      <nav className="w-screen h-[8vh] flex items-center justify-between shadow-lg hover:shadow-2xl duration-300 transition-all hover:shadow-slate-900 px-[2vw]">
        <motion.div viewport={{ once: true }}
          ...
          /> :<Link to={'/home'} className={`vmd:block sm:hidden font-bold no-underline 2xl:text-[20px] sm:text-[18px] vmd:text-[12px] rounded-md text-[10px] text-black hover:text-blue-600 transition-all duration-100`}>
        ...
        <div className={`absolute sm:hidden w-[50vw] h-screen flex items-center justify-center gap-[10px] duration-200 bg-slate-800 shadow-inner shadow-slate-800 rounded-r-3xl translate-y-[90px] ${translate} transition-all duration-300`}
        >
