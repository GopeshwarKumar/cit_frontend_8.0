      ...
      <nav className="w-screen h-[75px] flex items-center justify-between shadow-lg hover:shadow-2xl duration-300 transition-all hover:shadow-slate-900 px-[5vw]">
        ...
        <div className="flex items-center gap-[10px] ">
          ...
          <div className="group flex flex-col items-center gap-2">
            ...
            whileInView={{ opacity: 1, translateY: 0 }}
            transition={{ duration: 0.2 }}
            className={` ${location.pathname === "/about" && "bg-red-400 rounded-md"} vmd:hidden sm:block font-bold no-underline py-[2px] px-[10px] 2xl:text-[20px] sm:text-[18px] vmd:text-[12px] text-white hover:text-yellow-300 transition-all duration-100 flex flex-col items-center gap-2`}>
            About Us
            </Link>
          </div>
