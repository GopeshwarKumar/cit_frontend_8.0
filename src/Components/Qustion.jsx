...
function Qustion() {
  ...
  const [timetextcolor,settimetimetextcolor]=useState("text-green-500")
  ...
  useEffect(()=>{
    const interval=setInterval(() => {
      ...
      // changing text color 
      if(min<=10){
        settimetimetextcolor("text-red-700")
      }
      setimetminute(min)
      settimesecond(sec);
    }, 1000);
  ...
  return (
    ...
    <Navbar/>
    {/* timer */}
    <div className='w-screen flex items-center justify-center bg-slate-900 fixed'>
        <h1 className={`text-nowrap ${timetextcolor} animate-pulse`}>
